...
> ⚠️ **הדלקה באמצע היום שולחת מיד.** הבדיקה היא "האם שעת השליחה כבר עברה היום", אז אם מדליקים ב-14:00 ושעת השליחה היא 07:30 — התוכן של היום יוצא בטיק הקרוב (עד 30 שניות). כדי להימנע: להדליק כשהמתזמן ב-pause, ולשחרר בבוקר למחרת.
